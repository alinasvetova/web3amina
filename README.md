...
## Project Overview
This repository contains the implementation of a fully functional CRUD (Create, Read, Update, Delete) API for a simple blogging platform, as required by Assignment 3. The project utilizes Node.js and Express for the server-side architecture and MongoDB (Atlas) for data persistence. A client-side interface is included to demonstrate the API functionality.
